...
Config.instname = "University of Copenhagen"
Config.profilename = "eduroam"
Config.url = "http://it.ku.dk/english/"
Config.email = "UCPH-IT-Support@ku.dk"
Config.title = "eduroam CAT"
Config.server_match = "radius.ku.dk"
...
Config.user_realm = "ku.dk"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.ku.dk']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@ku.dk"
Config.tou = ""
